...
# from https://github.com/hansthompson/rusps

# Run install.packages('XML") if first time
require(XML)
validate_address_usps <- function(street, city, state) {
  ...
  host_with_start_tag <- paste0(scheme_host_path, "348PERSE4302", "\">")
